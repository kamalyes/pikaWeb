...
import NoTableData from "@/assets/no_search.svg";
...
const defaultFooterDom = (
  <DefaultFooter
    copyright={<span>{new Date().getFullYear()} Kamalyes个人出品 <a
      href="https://beian.miit.gov.cn">鄂ICP备20001608号</a></span>}
    links={[
      {
        key: 'pikaWeb',
        title: 'pikaWeb',
      ...
      },
      {
        ...
        href: 'https://github.com/kamalyes/pikaWeb',
        blankTarget: true,
      }
    ]}
  />
